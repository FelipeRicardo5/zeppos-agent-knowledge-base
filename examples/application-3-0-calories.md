...
Source: `zeppos-samples/application/3.0/calories`
...
```
— `zeppos-samples/application/3.0/calories/utils/constants.js`, line 8
...
```
— `zeppos-samples/application/3.0/calories/utils/storage.js`, line 26
...
```
— `zeppos-samples/application/3.0/calories/utils/storage.js`, line 20
...
```
— `zeppos-samples/application/3.0/calories/utils/storage.js`, line 10
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.r.layout.js`, line 8
...
back();
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 31
...
```
— `zeppos-samples/application/3.0/calories/page/gt/index.js`, line 83
...
```
— `zeppos-samples/application/3.0/calories/page/gt/index.js`, line 68
...
logger.log("--->e:", e);
```
— `zeppos-samples/application/3.0/calories/app.js`, line 18

```js
logger.log("onInit");
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 26
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 65
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 72
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 34
...
```
— `zeppos-samples/application/3.0/calories/page/gt/index.js`, line 33
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 80
...
```
— `zeppos-samples/application/3.0/calories/page/gt/food-list.js`, line 87
