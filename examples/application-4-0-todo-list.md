...
AppSettingsPage({
  ...
  editTodoList(val, index) {
    ...
    this.setItem()
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 3
  ...
  BaseSideService({
    ...
    onRequest(req, res) {
      if (req.method === 'GET_TODO_LIST') {
        ...
        const newTodoList = [...todoList, String(Math.floor(Math.random() * 100))]
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 11
...
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 103
...
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 53

```js
label: gettext('delete'),
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 104
...
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 6

```js
result: getTodoList()
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 17
...
onDestroy() {}
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 45
...
onInit() {},
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 13
...
onRun() {},
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 44
...
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 16
...
```
— `zeppos-samples/application/4.0/todo-list/app-side/index.js`, line 25
...
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 52
...
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 84
...
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 38
...
View(
  ...
  [
    View(
```
— `zeppos-samples/application/4.0/todo-list/setting/index.js`, line 62
